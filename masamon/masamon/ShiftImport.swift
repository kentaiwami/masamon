        ...
        if(filenamefield.text != ""){
            ...
            if(filemanager.fileExistsAtPath(Libralypath+"/"+filenamefield.text!)){       //入力したファイル名が既に存在する場合
                ...
                let updateAction:UIAlertAction = UIAlertAction(title: "上書き",
                    ...
                    handler:{
                        ...
                        do{
                            ...
                            ShiftRegister().ShiftDBOnecoursRegist(self.filenamefield.text!, importpath: self.Libralypath+"/"+self.filenamefield.text!)
                        }catch{
                            print(error)
                        }
                })
                ...
                do{
                    ...
                    ShiftRegister().ShiftDBOnecoursRegist(filenamefield.text!, importpath: Libralypath+"/"+filenamefield.text!)
                }catch{
                    print(error)
                }
            }
