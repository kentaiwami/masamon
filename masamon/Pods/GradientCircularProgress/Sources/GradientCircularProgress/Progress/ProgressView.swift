...
class ProgressView: UIView {
    ...
    fileprivate var progressAtRatioView: ProgressAtRatioView?
    fileprivate var circularProgressView: CircularProgressView?
    ...
    fileprivate func initialize(_ frame: CGRect) {
